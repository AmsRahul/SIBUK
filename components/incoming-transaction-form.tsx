...
export default function IncomingTransactionForm({ books, onAddTransaction, onBack }: IncomingTransactionFormProps) {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center space-x-4">
        ...
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Stock In Transaction</h1>
